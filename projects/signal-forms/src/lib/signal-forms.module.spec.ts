...
describe('signalForms', () => {
    ...
    describe('getValidatorResult', () => {
        it('should return the first error message generated by the validator functions', () => {
            let test1 = getValidatorResult(form.field1.validators, form.field1.currentValue())
            let test2 = getValidatorResult(form.field3.validators, form.field3.currentValue())
